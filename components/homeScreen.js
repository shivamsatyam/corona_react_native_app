...
export default () => {
  return (
        ...
        <Animatable.View
          ...
          animation="bounce">
            ...
            <View style={styles.prevention}>
              ...
              <Text  style={styles.prevention_text}>{"Since the start of the \n coronavirus outbreak \n some  place has fully \n embraced  wearing \nface masks, and  \n anyone caught without \n one risks become \n a social pariah"}  </Text>
              </View>
            </View>
   ...
   <View style={styles.prevention}>
              ...
              <View style={{flexWrap:"wrap"}}>
              <Text  style={styles.prevention_text}>{"These diseases include \n gastrointestinal \n  infections,  Such \n as Salmonella and\n respiratory infections,\n such as influenza  "}  </Text>
              </View>
            </View>
